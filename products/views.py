...
def category_list(request, category_id = None, product_search=None):
    ...
    if product_search:
        ...
        return render(request, 'products/productlist.html',{"product_search":product_search, "catlist": category_list_in, "products": products, 'category_id':category_id,  'us': us})
    else:
        return render(request, 'products/productlist.html', {"catlist": category_list_in, "products": products, 'category_id': category_id,  'us': us})
def search_products(request, category_id = None, search_input = None):
    ...
    return render(request, 'products/productlist.html', {"catlist": category_list_in, 'category_id':category_id, "product_search": search_prod, "products": products, 'us': us})
